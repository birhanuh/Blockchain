...
class Blockchain {
   ...
   */
  createGenesisBlock() {
    return new Block('2021-01-01', [], null)
  }
  ...
  minePendingTransactions(miningRewardAddress) {
    ...
    this.pendingTransactions.push(rewardTx); // Here we add all the pending transaction but, in real world such as Bitcoin cos there are way to 
